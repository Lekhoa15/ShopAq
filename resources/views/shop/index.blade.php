...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav  ">
                        ...
                        @if (auth()->check() && auth()->user()->role == 'admin')
                            <li><a href="{{ route('banners.index') }}" class="btn btn-primary">Quản lý Banner</a></li>
                        @endif
                        {{-- <li class="nav-item">
                                    ...
                                    <div class="row">
                                        <div class="col-md-7">
                                            <div class="detail-box">
                                                <h1>{{ $banner->title }}</h1>
                                                <p>
                                                    Discover our latest collection of gifts just for you!
                                                </p>
    ...
    <section class="shop_section layout_padding">
        <div class="container">
            ...
            <div class="container">
                <div class="btn-box">
                    <!-- Nút để chuyển đến trang CRUD sản phẩm, chỉ hiện với admin -->
                    @if (auth()->check() && auth()->user()->role == 'admin')
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3">
                        <div class="box">
                            <a href="">
                                ...
                                <h6>Giá: <span style="color: red">${{ $product->price }}</span></h6>
                                <h6>Mô tả : <span>{{ $product->description }}</span></h6>
                            </a>
                            <!-- Nút thêm vào giỏ hàng -->
                            <button class="btn btn-success add-to-cart" data-id="{{ $product->id }}">Thêm vào giỏ
                                hàng</button>
                        </div>
                    </div>
                @endforeach
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <div class="info_link-box">
                            ...
                            <a href="">
                                ...
                                <span> lekhoa113115@gmail.com</span>
                            </a>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function() {
        // Xử lý sự kiện khi bấm nút "Load More"
        $('#load-more').click(function() {
            var page = $(this).data('page');

            $.ajax({
                url: '{{ route('products.load_more', '') }}/' + page,
                method: 'GET',
                success: function(response) {
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            <div class="box">
                                <a href="">
                                    ...
                                    <h6 style="color: red">Price <span>$${product.price}</span></h6>
                                    <h6>Mô tả: <span>${product.description}</span></h6>
                    ...
                    `);
                        ...
                        // Cập nhật số trang cho lần nhấn "Load More" tiếp theo
                        $('#load-more').data('page', page + 1);
                    } else {
                        // Nếu không còn sản phẩm thì ẩn nút "Load More"
                        $('#load-more').hide();
                    }
                }
            });
        ...
        $(document).on('click', '.add-to-cart', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    alert(response.success); // Thông báo thêm thành công

                    // Tăng số lượng giỏ hàng hiển thị trên icon mà không cần tải lại trang
                    var cartCount = parseInt($('#cart-count').text());
                    $('#cart-count').text(cartCount + 1); // Tăng số lượng lên 1
                }
            });
        });
        $('.avatar-icon').on('click', function() {
            $('.user-dropdown').toggle(); // Hiển thị hoặc ẩn dropdown khi bấm vào avatar
        });
